    ...
    <div class="container-fluid padding-top-bottom">
        <form method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="form-group <?php if (isset($err['age'])) echo 'has-error'; ?>">
                ...
                <div class="col-lg-5 col-md-5 col-sm-5">
                    <input placeholder="<?php echo date('Y-m-d');?>" type="text" id="reg_date" class="form-control" name="reg_date" <?php echo 'value="'.htmlspecialchars($row['reg_date']).'"';?>>
                </div>
            ...
            <div class="form-group <?php if (isset($err['age'])) echo 'has-error'; ?>">
                ...
                <div class="col-lg-5 col-md-5 col-sm-5">
                    <input placeholder="<?php echo date('Y-m-d');?>" type="text" id="last_active_date" class="form-control" name="last_active_date" <?php echo 'value="'.htmlspecialchars($row['last_active_date']).'"';?>>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 text-left">
                    <img class="img-thumbnail" src="/img/default/users/100x100/<?php echo htmlspecialchars($row['avatar']);?>" alt="">
                </div>
            </div>
