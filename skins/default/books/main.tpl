<div class="main">
    ...
    if (isset($author_search)) {
        ...
        <div class="author_info">
            ...
            <img alt="" src="/img/default/authors/100x100/<?php echo htmlspecialchars($author_search['img_name']); ?>">
        </div>
        <?php
    }
    if (isset($res, $how_total_pages, $data)) {
        ...
        ?>
            <div class="books_list">
                <div class="for_img">
                    <img alt="" src="/img/default/books/200x200/<?php echo htmlspecialchars($v['img_name']);?>">
                </div>
