<div class="main">
	...
	<div class="profile">
		...
		<form method="post" class="form_profile" enctype="multipart/form-data">
			<div class="left_side">
				<img src="/img/default/users/100x100/<?php echo htmlspecialchars($user['avatar']);?>" alt ="">
				<div class="file_div">
			...
			<div class="right_side">
				<p>Статус на сайте</p>
				<img src="img/default/users/<?php if ($user['access'] == 5) echo 'admin'; else echo 'user';?>_role.jpg" alt="">
			</div>
			<div class="clear"></div>
			<div class="reg_footer">
