...
<div class="main" id="main">
		...
		<div class="photo">
			...
			if (isset($_SESSION['user'])) {
			    if (!empty($_SESSION['user']['avatar'])) {
                    echo '<img alt="" src="/img/default/users/100x100/'.htmlspecialchars($_SESSION['user']['avatar']).'">';
                } else {
                    echo '<img alt="" src="/img/default/users/100x100/noavatar.png">';
                }
	...
	<div class="comments">
		<div class="photo">
			<img alt="" src="/img/default/users/100x100/
			<?php
            if (empty($row['avatar']))
                echo 'noavatar.png';
            else
...
<?php if (isset($info_name)) { ?>
    ...
    <div id="info_text">
        ...
        <div class="info_main">
            <img src="/img/default/comments/<?php if($info_type == 'success') echo 'galochka.png'; else echo 'attantion.png';?>" alt="">
