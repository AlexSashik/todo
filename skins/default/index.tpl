...
<html lang="ru">
	...
	<head>
		...
		<link href="/css/<?php echo CORE::$STYLE?>/all_header_footer1.07.css" rel="stylesheet" type="text/css">
		<?php	if(isset(CORE::$CSS) ) echo implode("\n", CORE::$CSS);?>
        <script src="http://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>

		<script defer src="/js/<?php echo CORE::$STYLE?>/header_effects1.03.js"></script>
