<div class="main">
	...
	<div class="desc_price_buy <?php if ($row['is_in_sight'] == '0') echo 'out_of_sight'; else echo 'in_sight';?>">
		<img class="desc_img" src="/img/default/goods/250x250/<?php echo htmlspecialchars($row['main_img']);?>" alt="">
		<?php
	...
	<div class="desc_text">
		...
		if ($res_img->num_rows > 1) {
			...
			while ($row_img = $res_img->fetch_assoc()) {
				echo '<img alt="" src="/img/default/goods/100x100/'.htmlspecialchars($row_img['img_name']).'">';
